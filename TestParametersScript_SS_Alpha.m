...
%% ISSembed process	
    ...
    %Modified
    fprintf('Testing alpha from %f to %f by %f:\n', lowerbound, upperbound, offset);
    %
    ...
    for alpha_i = lowerbound: offset : upperbound
        ...
        watermarkedImg = SpreadSpectrumEmbed(orgImg, b, u, alpha_i, blockSize);
        %
