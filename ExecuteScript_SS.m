function ExecuteScript_SS(InputImage_Name, wmLen, patternLen, blockSize, alpha)

fprintf('Spread Spectrum Watermarking\n\n');

% Execute SS embed and extract process
...
%% SSextract process
	...
	watermark1 = SpreadSpectrumExtract(attackedImg1, u, blockSize, n);
    watermark2 = SpreadSpectrumExtract(attackedImg2, u, blockSize, n);
    watermark3 = SpreadSpectrumExtract(attackedImg3, u, blockSize, n);
    watermark4 = SpreadSpectrumExtract(attackedImg4, u, blockSize, n);
    watermark5 = SpreadSpectrumExtract(attackedImg5, u, blockSize, n);
    watermark6 = SpreadSpectrumExtract(attackedImg6, u, blockSize, n);
    watermark7 = SpreadSpectrumExtract(attackedImg7, u, blockSize, n);
    watermark8 = SpreadSpectrumExtract(attackedImg8, u, blockSize, n);
    watermark9 = SpreadSpectrumExtract(attackedImg9, u, blockSize, n);
